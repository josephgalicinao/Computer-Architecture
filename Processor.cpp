...
bool Processor::Disassemble(u16 address)
{
    ...
    if ((map[offset]->size == 0) || changed)
    {
        ...
        // std::ofstream file("assembly.txt", std::ios::app);
        // std::cout << "PC: " << map[offset]->address << std::endl;
        // std::cout << "Inst: " << map[offset]->name << std::endl;
        // std::cout << "Jump taken: " << map[offset]->jump << std::endl;
